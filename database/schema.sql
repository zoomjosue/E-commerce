...
-- Acelerar búsquedas de productos por precio de reportes de rango de precio
CREATE INDEX `idx_producto_precio` ON `PRODUCTO`(`precio`);
-- Acelerar filtrado de ventas por estado de reportes de ventas pendientes/completadas
CREATE INDEX `idx_venta_estado` ON `VENTA`(`estado`);
-- Acelerar búsquedas de clientes por nombre
